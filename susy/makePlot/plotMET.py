...
if DoZjets==True:
    ...
    PlotnJetsZjets.pushaft("after",fin.Get(tag+"_ELE_Bnjet_SR1_ele_bjj_gammamatchnonele_ZJets"),col=kRed,scal=sf_zjets_gamma/1.4)
    PlotnJetsZjets.addaft(fin.Get(tag+"_ELE_Bnjet_SR1_ele_bjj_gammamatchele_ZJets"),scal=sf_zjets_efakep/1.4)
