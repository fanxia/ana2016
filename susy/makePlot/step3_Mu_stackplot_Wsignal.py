...
#     sepSig=True  
     ...
     Stack.drawStack('BpfMET', cut_SR2_bjj, str(lumi*1000), xBins_pfMET, 0, 1000, channel = "mu_bjj: SR2", titlex = "pfMET", units = "GeV",output=tag+'pfMET_SR2_mu_bjj',outDir=outdir,separateSignal=sepSig)
     Stack.drawStack('BpfMET', cut_SR2_bjj, str(lumi*1000), xBins_pfMET, 0, 1000, channel = "mu_bjj: SR2", titlex = "pfMET", units = "GeV",blinding=True,output=tag+'pfMETblind_SR2_mu_bjj',outDir=outdir,separateSignal=sepSig)


     Stack.drawStack('BpfMET', cut_SR1_bjj, str(lumi*1000), xBins_pfMET, 0, 1000, channel = "mu_bjj: SR1", titlex = "pfMET", units = "GeV",blinding=True,output=tag+'pfMETblind_SR1_mu_bjj',outDir=outdir,separateSignal=sepSig)
     ...
     Stack.drawStack('BMHT', cut_SR1_bjj, str(lumi*1000), xBins_pfMET, 0, 1000, channel = "mu_bjj: SR1", titlex = "MHT", units = "GeV",output=tag+'MHT_SR1_mu_bjj',outDir=outdir,separateSignal=sepSig)
     ...
     Stack.drawStack('BCandphoEt', cut_SR1_bjj_4gamma, str(lumi*1000), xBins_Pt, 0, 1000, channel = "mu_bjj: SR1", titlex = "#gamma E_{T}", units = "GeV",output=tag+'phoEt_SR1_mu_bjj',outDir=outdir,separateSignal=sepSig)
